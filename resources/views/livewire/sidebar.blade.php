<div class="col-lg-3 primary-sidebar sticky-sidebar">
    ...
    <div class="widget-category mb-30 rounded-3xl border-slate-200 shadow-md">
        <h1 class="font-bold text-lg tracking-widest text-orange-500 mb-2 uppercase">Categorías</h1>
        <ul class="categories">
    ...
    <div class="sidebar-widget price_range range mb-30 rounded-3xl border-slate-200 shadow-md" style="border-radius: 30px">
        <h1 class="font-bold text-lg tracking-widest text-orange-500 mb-4 uppercase">Filtrar por precio</h1>
                ...
                <div class="price-filter-inner">
                    ...
                    <div class="price_slider_amount">
                        <div class="label-input">
                            <span>Rango:</span>
                            <input type="text" id="amount" name="range" placeholder="Formato requerido $xx - $xx">
                        </div>
                    </div>
                </div>
