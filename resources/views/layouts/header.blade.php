            ...
            <div class="header-wrap flex justify-between items-center">
                ...
                <div class="search-style-1 flex-grow px-20">
                    <form action="{{ route('home') }}" class="w-100">
                        <input id="search" name="search" type="text" placeholder="Busca cualquier producto, categoría, marca..."/>
                    </form>
                </div>
                <div class="header-action-right">
                    <div class="header-action-2">
                        @auth
                            <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                                <nav class="">
                                    <ul class="">
                                        <li>
                                            <h1 class="text-black font-bold text-[1rem]">Hola, {{ Auth::user()->name }}</h1>
                                        </li>
                                        <li><a href="#">Mi Cuenta<i class="fi-rs-angle-down"></i></a>
                                            <ul class="sub-menu">
                                                ...
                                                @endif
                                                <li><a href="{{ route('dashboard') }}">Panel de Pedidos</a></li>
                                                <li><a href="{{ route('profile.edit') }}">Configuración de Cuenta</a></li>
                                                <li>
                        ...
                        @else
                            <a href="{{ route('login') }}" class="pr-4 text-md font-semibold ">Iniciar sesión</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-sm btn-default">Registrarse</a>
                            @endif
                        @endauth
                                    ...
                                    @foreach (Cart::content() as $item)
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                <h4><a href="{{ route('product.details', $item->model->id) }}">
